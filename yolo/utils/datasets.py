...
def gstreamer_pipeline(
    sensor_id=0,
    capture_width=parm.HD_Width,
    capture_height=parm.HD_Height,
    display_width=parm.HD_Width,
    display_height=parm.HD_Height,
    framerate=30,
    flip_method=0,
):
    return (
...
class LoadWebcam:  # for inference
    def __init__(self, pipe='0', img_size=640, stride=32):
        ...
        self.cap = cv2.VideoCapture(gstreamer_pipeline(flip_method=2), cv2.CAP_GSTREAMER)  # video capture object
